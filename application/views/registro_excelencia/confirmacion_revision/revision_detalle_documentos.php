...
<div class="">
    ...
    <table class="table ">
        ...
        <tbody>
            ...
            <tr>
                <td class="col-sm-4"><?php echo $value['nombre'] ?></td>
                <td class="col-sm-4"><?php echo str_replace('||X||', base_url() . $documento[$value['id_tipo_documento']]['ruta'], $language_text['registro_excelencia']['reg_liga_msg_descarga']); ?></td>
