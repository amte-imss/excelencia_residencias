 ...
 * @author      : JZDP
 * */
class Confirmacion_revision extends MY_Controller {
...
//        $this->get_cursos_participacion($solicitud)
            ...
            $main_content = $this->load->view('registro_excelencia/confirmacion_revision/confirmacion_revision.tpl.php', $output, true);
        } else {
            $main_content = $this->load->view('registro_excelencia/registro_no_disponible.tpl.php', $output, true);
        }
        $this->template->setMainContent($main_content);
...
//        pr($output['evaluacion']);
        if (!is_null($tipo)) {
            $cursos_doc = $this->load->view('registro_excelencia/confirmacion_revision/revision_detalle_cursos.php', $output, true);
        } else {
            $cursos_doc = $this->load->view('registro_excelencia/confirmacion_revision/revision_cursos.php', $output, true);
        }
        return $cursos_doc;
    }
...
//        pr($output['evaluacion']);
        if (!is_null($tipo)) {
            $documentos_doc = $this->load->view('registro_excelencia/confirmacion_revision/revision_detalle_documentos.php', $output, true);
        } else {
            $documentos_doc = $this->load->view('registro_excelencia/confirmacion_revision/revision_documentos.php', $output, true);
        }
